      ...
      bcrypt
        ...
        .then(doMatch => {
          ...
          return res.status(422).render('auth/login', {
            path: '/login',
            pageTitle: 'Login',
            errorMessage: 'Please citra sayang, enter password dengan benar!',
            oldInput: {email, password},
  ...
  if (!errors.isEmpty()) {
    // console.log(errors.array());
      //  ==> [ {  
        //        location: 'body',
        //        param: 'email',
        //        value: 'citra@gmail2.com',
        //        msg: 'E-Mail exists already, please pick a different one.' },
        //     {  location: 'body',
        //        param: 'confirmPassword',
        //        value: 'citrA1234',
        //        msg: 'Password harus match citra sayang!' },
        //    ...
        //    ]

    // we want render if not success
    // only success, we redirect
